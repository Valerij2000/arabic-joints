...
$offer_id = 6912;         // для каждого оффера свой айди, надо уточнять его в админке или у суппортов
$stream_hid = 'RnwTdzEY';     // id потока

$landKey = 'a7238eb4f246566ee8879a40c0cbeea4';
...
$dataOffers = '{"25794":{"id":25794,"name":"Easy Move","country":{"code":"EG","name":"\u0415\u0433\u0438\u043f\u0435\u0442"},"price":"649","price2":"1298","currency":{"code":"EGP","name":"\u0627\u0644\u062c\u0646\u064a\u0647 \u0627\u0644\u0645\u0635\u0631\u0649"}}}';
$dataOffer = '{"id":25794,"name":"Easy Move","country":{"code":"EG","name":"\u0415\u0433\u0438\u043f\u0435\u0442"},"price":"649","price2":"1298","currency":{"code":"EGP","name":"\u0627\u0644\u062c\u0646\u064a\u0647 \u0627\u0644\u0645\u0635\u0631\u0649"}}';
$is_geo_detect = '';
$productName = 'Easy Move';
$invoice = 'index.php';
$language = 'ar';
$push_link = '';
$fb_verification = '';
...
$companyInfo = array('address' => '620100, Свердловская область, г. Екатеринбург, ул. Ткачей, стр. 23, офис 713', 'detail' => 'ОБЩЕСТВО С ОГРАНИЧЕННОЙ ОТВЕТСТВЕННОСТЬЮ "РОКС ТРЕЙД" ОГРН: 1196658050577 ИНН: 6685165026 КПП: 668501001');
